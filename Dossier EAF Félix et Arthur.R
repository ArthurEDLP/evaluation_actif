...
JUVE_MI <- data.table(read_excel("base_1.xlsx"),ticker="JUVE_MI")
SSL_MI <- data.table(read_excel("base_2.xlsx"),ticker="SSL_MI")
XXT_SG <- data.table(read_excel("base_3.xlsx"),ticker="XXT_SG")
CCP_L <- data.table(read_excel("base_4.xlsx"),ticker="CCP_L")
BVB_MU <- data.table(read_excel("base_5.xlsx"),ticker="BVB_MU")
SCP_LS <- data.table(read_excel("base_6.xlsx"),ticker="SCP_LS")
AAB_CO <- data.table(read_excel("base_7.xlsx"),ticker="AAB_CO")
GSRAY_IS <- data.table(read_excel("base_8.xlsx"),ticker="GSRAY_IS")
AJAX_AS <- data.table(read_excel("base_9.xlsx"),ticker="AJAX_AS")
SOL_USD   <- data.table(read_excel("base_10.xlsx"),ticker="SOL_USD")
